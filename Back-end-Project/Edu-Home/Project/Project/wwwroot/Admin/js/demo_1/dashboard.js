(function ($) {
    ...
    //let ModelDescription = $("#inputDescription").val();
    //let title = $("#inputTitle").val();
    //let ModelTitle = $(".Title").val();
    //if (description == ModelDescription && title == ModelTitle) {
    //    $(".btn-success").prop("disabled", true);
    //}
    //$("#inputDescription").keyup(function () {
    //    if ($(this).val() == "" || $(this).val() == ModelDescription) {
    //        $(this).parent.children(".btn-success").prop("disabled", true);
    //    }
    //    else {
    //        $(this).parent().children(".btn-success").prop("disabled", false);
    //    }
    //})

    //$("#inputTitle").keyup(function () {
    //    if ($(this).val() == "" || $(this).val() == ModelTitle) {
    //        $(".btn-success").prop("disabled", true);
    //    }
    //    else {
